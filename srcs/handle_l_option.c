...
/*   Updated: 2017/03/05 00:04:34 by bjanik           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_ls.h"

void	set_maxs(t_dir *dir, t_max *max)
{
	int	len;
...
static void	fill_struct(t_dir *dir, t_max *max)
{
	dir->user = getpwuid(dir->stat.st_uid);
	dir->group = getgrgid(dir->stat.st_gid);
